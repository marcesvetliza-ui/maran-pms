                      ...
                      <TableRow key={m.id} data-testid={`movement-row-${m.id}`} className={`${m.anulado ? "opacity-40" : ""} cursor-pointer hover:bg-muted/40`} onClick={() => setExpandedMovId(expandedMovId === m.id ? null : m.id)}>
                        ...
                        <TableCell>
                          {m.anulado ? (
                            ...
                            <Badge className="bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300">Liquidación informativa</Badge>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">No monetarias</TableHead>
              ...
              <TableBody>
                {history.map((row: any) => (
                  <TableRow key={row.id} data-testid={`history-row-${row.id}`}>
                    ...
                    <TableCell className="text-right font-medium">
                      {row.nonCashSettlementsTotal != null ? formatCurrency(row.nonCashSettlementsTotal) : "-"}
                    </TableCell>
                    <TableCell>
                      <Button
                        variant="outline"
