import{r as y,g as p,b as w,j as e,I as k,B as x,R as v,n as h,L as g,p as A,m as T}from"./index-_8LKl-om.js";import{S as O}from"./skeleton-oHUn_bUd.js";import{P as S}from"./printer-RMEdYyo2.js";function c(s){if(!s)return"-";const[d,i,o]=s.split("-");return`${o}/${i}/${d}`}function l(s){return s==null?"-":`$${s.toLocaleString("es-AR",{minimumFractionDigits:0,maximumFractionDigits:0})}`}function I(s){return s?new Date(s+"T12:00:00").toLocaleDateString("es-AR",{weekday:"long",year:"numeric",month:"long",day:"numeric",timeZone:"America/Argentina/Buenos_Aires"}):""}const R=`
@page {
  size: A4 portrait;
  margin: 10mm 8mm;
}
