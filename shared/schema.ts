...
export const cashClosingSummaries = pgTable("cash_closing_summaries", {
  ...
  totalVoucher: numeric("total_voucher", { precision: 10, scale: 2 }).default("0"),
  nonCashSettlementsTotal: numeric("non_cash_settlements_total", { precision: 10, scale: 2 }).default("0"),
  nonCashSettlementsCount: integer("non_cash_settlements_count").default(0),
...
export const salesInvoices = pgTable("sales_invoices", {
  ...
  cashFormaPagoDetalle: jsonb("cash_forma_pago_detalle"),
