...
**Why:** Confirmed directly with the user as the target spec after auditing inconsistent receipt selectors across modules (some had Factura C or NC mixed into close-account dialogs).
