import {
  ...
  type RoomType,
  type InsertRoomType,
  type RoomTypeReferencePreview,
  type RoomTypeReferenceExportPage,
...
export interface IStorage {
  ...
  getRoomTypeReferencePreview(roomTypeId: string, source: RoomTypeReference["source"], limit?: number): Promise<RoomTypeReferencePreview>;
  getRoomTypeReferenceExportPage(
    roomTypeId: string,
  ...
  getReportGroupPayments(from: string, to: string, groupId?: string, status?: string): Promise<any[]>;
  getReportGroupPaymentsGroupOptions(from: string, to: string): Promise<{ id: string; label: string }[]>;
