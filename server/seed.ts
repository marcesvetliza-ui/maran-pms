...
export async function seedDatabase() {
  ...
  await db.insert(rooms).values([
    ...
    { id: "r1004", roomNumber: "1004", roomTypeId: "rt1", floor: 10, status: "available", bedConfig: "MAT", features: ["shower_only"], maxOccupancy: 2, notes: null },
    ...
    { id: "r1007", roomNumber: "1007", roomTypeId: "rt2", floor: 10, status: "available", bedConfig: "MAT_CC", features: ["separable_bed"], maxOccupancy: 2, notes: null },
    ...
    { id: "r1104", roomNumber: "1104", roomTypeId: "rt1", floor: 11, status: "available", bedConfig: "MAT", features: ["shower_only"], maxOccupancy: 2, notes: null },
    { id: "r1105", roomNumber: "1105", roomTypeId: "rt3", floor: 11, status: "available", bedConfig: "MAT_CC_EXTRA", features: ["separable_bed", "living_room", "balcony"], maxOccupancy: 4, notes: null },
    { id: "r1106", roomNumber: "1106", roomTypeId: "rt3", floor: 11, status: "available", bedConfig: "MAT_EXTRA", features: ["extra_bed", "living_room", "balcony"], maxOccupancy: 5, notes: null },
    { id: "r1107", roomNumber: "1107", roomTypeId: "rt2", floor: 11, status: "available", bedConfig: "MAT_CC", features: ["separable_bed"], maxOccupancy: 2, notes: null },
    ...
    { id: "r1204", roomNumber: "1204", roomTypeId: "rt1", floor: 12, status: "available", bedConfig: "MAT", features: ["shower_only"], maxOccupancy: 2, notes: null },
    { id: "r1205", roomNumber: "1205", roomTypeId: "rt3", floor: 12, status: "available", bedConfig: "MAT_CC_EXTRA", features: ["separable_bed", "living_room", "balcony"], maxOccupancy: 4, notes: null },
    { id: "r1206", roomNumber: "1206", roomTypeId: "rt3", floor: 12, status: "available", bedConfig: "MAT_EXTRA", features: ["extra_bed", "living_room", "balcony"], maxOccupancy: 5, notes: null },
    { id: "r1207", roomNumber: "1207", roomTypeId: "rt2", floor: 12, status: "available", bedConfig: "MAT_CC", features: ["separable_bed"], maxOccupancy: 2, notes: null },
  ]);
