...
// requireAuth (real) efectivamente protege estas dos rutas — antes de la
// Fase 9 estaban registradas sin ningún guard (hallazgo de la Fase 8).
...
describe("registerDebugAssetRoutes — Fase 9: ya no son públicas", () => {
  afterEach(() => {
    vi.clearAllMocks();
  });
